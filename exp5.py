...
# The list will have dimensions (jug1+1) x (jug2+1) to cover all possi
 ble states 
...
def waterJug(vol1, vol2): 
 ...
 return ( 
        ...
        waterJug(vol1 + min(vol2, (jug1 - vol1)), vol2 - min(vol2, (ju
 g1 - vol1))) or  # Pour water from jug2 to jug1 
        waterJug(vol1 - min(vol1, (jug2 - vol2)), vol2 + min(vol1, (ju
 g2 - vol2)))  # Pour water from jug1 to jug2 
    )  
